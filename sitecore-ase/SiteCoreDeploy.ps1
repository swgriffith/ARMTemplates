$ArmTemplateUrl = "https://raw.githubusercontent.com/swgriffith/ARMTemplates/master/sitecore-ase/xm/azuredeploy.json";
$ArmParametersPath = ".\xm\azuredeploy.parameters.json";
...
$Name = "SiteCoreTest";
$location = "East US";
$AzureSubscriptionId = "62afe9fc-190b-4f18-95ac-e5426017d4c8";
